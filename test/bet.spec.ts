...
const handOutcome_b = new HandOutcome(HandResult.BancoWins, 20, 100, [ace, two], [ace, two], 20, 0)
bankerBet.setOutcome(handOutcome_b)
const tieBet = new Bet(new Tie(), 100)
const handOutcome_tie = new HandOutcome(HandResult.Tie, 20, 100, [ace, two], [ace, two], 20, 0)
